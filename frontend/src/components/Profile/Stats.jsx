    ...
    <>
      <div className='h-full w-full flex flex-row justify-center items-center gap-2'>
        ...
        <motion.div
          ...
          <div className='h-full w-full flex flex-col justify-between'>
            <div className='flex flex-col gap-1 '>
              <span className='text-[7px] md:text-[12.5px] font-semibold text-neutral-400 font-mono'>Focus Hours</span>
              <span className='font-bold md:text-2xl text-neutral-200 font-mono'>58 hrs</span>
            </div>
            <div className='flex flex-row justify-start items-center gap-1'>
              <div>
                <IconSparkles className='h-3 w-3 text-green-600 md:h-4 md:w-4' />
              </div>
              <span className='text-green-400 text-[7px] md:text-[10px] '>16 Sessions</span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          <div className='h-full w-full flex flex-col justify-between'>
            ...
            <div className='flex flex-row justify-start items-center gap-1'>
              ...
              <span className='text-blue-500 text-[7px] md:text-[10px] '>Out of 20 </span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          <div className='h-full w-full flex flex-col justify-between'>
            <div className='flex flex-col gap-1 '>
              <span className='text-[7px] md:text-[12.5px] font-semibold text-neutral-400 font-mono'>Karma Score</span>
              <span className='font-bold md:text-2xl text-neutral-200 font-mono'>847/1000</span>
            </div>
            <div className='flex flex-row justify-start items-center gap-1'>
              <div>
        ...
        <motion.div
          ...
          <div className='h-full w-full flex flex-col justify-between'>
            <div className='flex flex-col gap-1 '>
              <span className='text-[7px] md:text-[12.5px] font-semibold text-neutral-400 font-mono'>Streak</span>
              <span className='font-bold md:text-2xl text-neutral-200 font-mono'>6</span>
            </div>
            <div className='flex flex-row justify-start items-center gap-1'>
              <div>

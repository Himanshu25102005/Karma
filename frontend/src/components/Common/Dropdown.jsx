...
// Create a Context for positioning the checkmark/indicator
...
// Define size variants for the Trigger box
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          // Changed bg-popover to bg-black and border-border to border-white
          'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border-2 border-white bg-black shadow-xl text-white data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2',
          position === 'popper' &&

'use client'
import { IconClock, IconTrophy, IconAlertTriangle, IconBulb, IconSparkles, IconChevronLeft, IconChevronRight } from '@tabler/icons-react'
...
const INSIGHT_CARDS = [
    {
        ...
        gradient: 'bg-gradient-to-b from-[#7a5eec]/10 via-transparent to-transparent',
        footerGradient: 'bg-gradient-to-b from-[#7a5eec]/10 via-transparent to-transparent',
    ...
    },
    {
        ...
        gradient: 'bg-gradient-to-b from-[#5CE65C]/10 via-transparent to-transparent',
        footerGradient: 'bg-gradient-to-b from-[#5CE65C]/10 via-transparent to-transparent',
    ...
    },
    {
        ...
        label: 'Focus Leak',
        gradient: 'bg-gradient-to-b from-[#d61512]/10 via-transparent to-transparent',
        footerGradient: 'bg-gradient-to-b from-[#d61512]/10 via-transparent to-transparent',
    ...
    },
    {
        ...
        gradient: 'bg-gradient-to-b from-[#305CDE]/10 via-transparent to-transparent',
        footerGradient: 'bg-linear-to-b from-[#305CDE]/10 via-transparent to-transparent',
...
const cardBaseClass = 'min-h-[12rem] px-3 sm:px-4 py-2 sm:py-1.5 flex flex-col justify-between rounded-xl'
    ...
    return (
        ...
        >
            ...
            <div className="mt-4 flex flex-col gap-1">
                <span className={`${card.metricClass} font-bold text-white leading-none`}>
                    {card.getMetric(data)}
                </span>
                {subMetric && (
            ...
            <div className="mt-3">
                <p className="text-sm/5 text-neutral-300">
                    {card.getInsight(data)}
                </p>
            </div>

            {/* Footer */}
            <div className={`flex items-center justify-between mt-1 border w-fit p-0.5 px-1 rounded-md ${card.footerGradient} ${card.footerBorder}`}>
...
const Saarthi = () => {
    ...
    const goPrev = () => setActiveIndex((i) => (i - 1 + INSIGHT_CARDS.length) % INSIGHT_CARDS.length)

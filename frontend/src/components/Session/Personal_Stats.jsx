...
const Personal_Stats = ({ compact = false }) => {
  ...
  const insightCards = [
    {
      ...
      icon: (
        ...
        >
          <path
            d="M12 2C12 2 15 6.5 15 10.5C15 14.5 12 18 12 18"
            stroke="#F472B6"
            strokeWidth="1.5"
            strokeLinecap="round"
          ...
          />
          <path
            d="M12 5C12 5 18 10 18 15C18 20 12 22 12 22C12 22 6 20 6 15C6 10 12 5 12 5Z"
            stroke="#F472B6"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M12 9C12 9 9 12 9 15C9 18 12 19 12 19"
            stroke="#F472B6"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      extra: (
        <div className="flex flex-row justify-end items-center gap-1">
          ...
          <span className="text-[9px] text-neutral-400">
            From {summary?.summary?.[0]?.totalSessions} sessions
          </span>
        </div>
      ),
    },
  ...
  if (compact) {
    ...
    const goPrev = () =>
      setActiveInsight(
        (i) => (i - 1 + insightCards.length) % insightCards.length,
      );
    ...
    return (
      <div className="w-full min-w-0 p-2 flex flex-col gap-2">
        ...
        >
          <div
            className={`w-11 h-11 flex justify-center rounded-xl ${card.iconBg} items-center shrink-0`}
          >
            {card.id === "streak" ? (
              <motion.div
          ...
          <div className="flex-1 min-w-0 px-3 flex flex-col">
            <span className="text-base text-neutral-100 font-semibold leading-tight">
              {card.title}
            </span>
          ...
          <div className="shrink-0 flex flex-col justify-center items-end">
            <span className={`text-lg font-semibold ${card.valueClass}`}>
              {card.value}
            </span>
            {card.extra}
          </div>
        ...
        <div className="flex items-center justify-between gap-2 px-1">
          ...
          <span className="text-xs text-neutral-500 font-mono tabular-nums">
            {activeInsight + 1} / {insightCards.length}
          </span>
          <button
            type="button"
            onClick={goNext}
      ...
      >
        ...
        >
          ...
          <div className="h-full w-[50%] flex flex-col ">
            <span className="text-lg text-neutral-100 font-semibold leading-tight">
              Streak
            </span>
            <span className="text-sm text-neutral-500">
              {"Keep showing up. You're on a roll!"}
            </span>
          </div>
          <div className="h-full w-[25%] flex flex-col justify-center items-end">
            ...
            <div className="w-full h-[1.5rem] flex flex-row justify-end items-center gap-1 mt-0.5">
              {(() => {
                const streak = streakData?.currentStreak || 0;
                const greenBoxes =
                  streak === 0 ? 0 : streak % 7 === 0 ? 7 : streak % 7;
                const neutralBoxes = 7 - greenBoxes;
            ...
            <span className="text-xl w-full text-green-300/90 font-semibold">
              ...
              {(() => {
                ...
                const minutes = Math.floor(
                  (summary.totalFocusTime % 3600) / 60,
                );
        ...
        >
          ...
          <div className="h-full w-[25%] text-end">
            <span className="text-xl w-full text-blue-500 font-semibold">
